...
These images are concept references for mod art direction.
...
The files in this folder are not loaded directly by Minecraft. They are kept as visual references for future texture/model polishing.
